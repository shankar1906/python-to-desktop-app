...
This guide provides a comprehensive, step-by-step walkthrough to build a **new standalone industrial/desktop software project** from scratch, replicating the architecture used in `L-T_60MT_2Station`.
...
### Step 8 — Automated Build Pipeline Script (`build_desktop.ps1`)
